...
function VideoProvider(props) {
    const [associatedVideo, setAssociatedVideo] = react.useState(defaultVideo);

    const updateAssociatedVideo = react.useCallback((partial) => {
        setAssociatedVideo(prev => ({
            ...prev,
            ...partial
        }));
    }, []);
    ...
    return react.createElement(
        ...
        { value: { associatedVideo, updateAssociatedVideo } },
        props.children
    );
}
